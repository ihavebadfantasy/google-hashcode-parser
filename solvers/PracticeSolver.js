...
class PracticeSolver extends ProblemSolver{
  ...
  getPizzasForTeam(team) {
    ...
    for (let i = 2; i <= team.peopleCnt; i++) {
      ...
      // console.log('MAX UNIQ: ', maxUniqIngredientsCnt);
